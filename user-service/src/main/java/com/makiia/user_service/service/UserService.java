package com.makiia.user_service.service;

import com.makiia.user_service.client.FileStorageClient;
import com.makiia.user_service.enums.Active;
import com.makiia.user_service.enums.Role;
import com.makiia.user_service.exc.NotFoundException;
import com.makiia.user_service.model.User;
import com.makiia.user_service.model.UserDetails;
import com.makiia.user_service.repository.UserRepository;
...
public class UserService {
    ...
    public User updateUserById(UserUpdateRequest request, MultipartFile file) {
        ...
        request.setUserDetails(updateUserDetails((UserDetails) toUpdate.getUserDetails(), request.getUserDetails(), file));
